                ...
                <form action="users/checklogin" method="post">
                        ...
                        <form class="form" method="post" action="???????">
                            <div class="d1">
                                ...
                                <input type="text" id="idPwd1" name="old" value="" placeholder="請輸入現在使用的密碼"
                            ...
                            <div class="d3">
                                ...
                                </label> <input type="text" id="idPwd3" name="" value="" placeholder="請再次輸入新密碼"
                                    maxlength="30" size="20" autocomplete="off" aria-invalid="false"><br> <span
                                    id="h">確認密碼：&nbsp&nbsp&nbsp&nbsp</span><span id="idsp3" class="">&nbsp</span>
                            </div>
                    </div>
                    <div class="d4 modal-footer">
                        <button type="submit" class="btn btn-primary btnn" id="btn" disabled>變更密碼</button>
                    </div>
                </form>
            </div>
