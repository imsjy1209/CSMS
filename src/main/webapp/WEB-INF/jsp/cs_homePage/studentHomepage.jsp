		...
		<div class="content">
			<div class="aside">
				...
				<div class="menu">
					<ul>
						<li style="-i: 0.1s;">
							<button class="absCheckIcon btnli" data-toggle="modal"
								data-target="#absentMID">
								<i style="font-size: 90px;"
									class='bx bx-calendar-check hoverLight'> </i>
							</button>
						</li>
						<li style="-i: 0.2s;">
							<button class="lessonIcon btnli" data-toggle="modal"
								data-target="#courseMID">
								<i style="font-size: 90px;" class='bx bx-book hoverLight'
									title="課程"></i>
							</button>
						</li>
						<li style="-i: 0.3s;">
							<button class="activeIcon btnli" data-toggle="modal"
								data-target="#activityMID">
								<i style="font-size: 90px;"
									class='bx bx-universal-access hoverLight'></i>
							</button>
						</li>
						<li style="-i: 0.4s;">
							<button class="scoreIcon btnli" data-toggle="modal"
			...
			<div class="article ">
				<!-- 輪播區 -->
				<div class="announcementDiv" style="width: 100%;">
					<!-- 輪播bar -->
					<div id="carouselExampleIndicators" class="carousel slide"
						...
						<div class="carousel-inner">
							...
							<div class="carousel-item active" data-interval="3000"
								data-pause="hover">
								<img src="${contextRoot}/image/activityPhoto/01.jpg"
							...
							<div class="carousel-item" data-interval="3000"
								data-pause="hover">
								<img src="${contextRoot}/image/activityPhoto/02.jpg"
									class="d-block w-100" alt="...">
								<div class="carousel-caption d-none d-md-block">
									<!-- <div style="background-color: rgb(255, 153, 51, 0.7)">
										<h5>大家一起來散步</h5>
							...
							<div class="carousel-item" data-interval="3000"
								data-pause="hover">
								<img src="${contextRoot}/image/activityPhoto/03.jpg"
									class="d-block w-100" alt="...">
								<div class="carousel-caption d-none d-md-block">
									<!-- <div style="background-color: rgb(255, 153, 51, 0.7)">
										<h5>益智模型</h5>
							...
							<!-- 第4張 -->
							<div class="carousel-item" data-interval="3000">
								<img src="${contextRoot}/image/activityPhoto/04.jpg"
									class="d-block w-100" alt="...">
								<div class="carousel-caption d-none d-md-block">
									<!-- <div style="background-color: rgb(255, 153, 51, 0.7)">
										<h5>參觀博物館</h5>
