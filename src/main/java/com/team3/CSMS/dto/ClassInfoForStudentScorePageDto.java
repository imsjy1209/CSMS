...
public class ClassInfoForStudentScorePageDto implements Serializable {
	private static final long serialVersionUID = 1L;

	private Integer classListId; // 會放option value屬性的值
	...
	public ClassInfoForStudentScorePageDto() {
	}
	
	public ClassInfoForStudentScorePageDto(ClassList classList) {
		super();
