...
public class ContactBookListAdminVerDto implements Serializable {
	...
	public ContactBookListAdminVerDto() {
	}
	
	public ContactBookListAdminVerDto(ContactBook contactBook) {
		super();
