...
public class ContactBookListSchoolVerDto implements Serializable {
	...
	public ContactBookListSchoolVerDto() {
	}
	
	public ContactBookListSchoolVerDto(ContactBook contactBook) {
		super();
