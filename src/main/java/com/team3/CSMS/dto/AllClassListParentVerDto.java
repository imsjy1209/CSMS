...
public class AllClassListParentVerDto implements Serializable {
	...
	public AllClassListParentVerDto() {
	}
	
	public AllClassListParentVerDto(ClassList classList) {
		super();
		...
		this.studentId = classList.getClassStudentLists().get(0).getStudent().getId();
	}
