...
public class ContactBookSignAdminVerDto implements Serializable{
    ...
    public ContactBookSignAdminVerDto() {	
    }
    
    public ContactBookSignAdminVerDto(ContactBookSign contactBookSign) {
    	super();
