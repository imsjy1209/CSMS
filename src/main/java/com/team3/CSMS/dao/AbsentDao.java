...
public interface AbsentDao extends JpaRepository<Absent, Integer> {
    ...
    "inner join Student as stu on stu.student_id = abs.fk_student_id"+
    "where CONVERT(varchar(12) , [days], 112 )= :dayz as abs"+
    "and fk_classId_id= :classCodeId ", nativeQuery = true)
    List<Absent>selectAbsentByDaysAndClassCodeId(@Param("classCodeId") Integer classCodeId,@Param("dayz") String dayz);
